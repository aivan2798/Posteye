function genfilter()
  ...
  switch(type_box)
  {
   ...
   var client_json=poster2(server_json,function(responsed){logs("response successfully applied");},stats);
 ...
 //   alert("action pending");
  switch(action_obj.value)
  {
   ...
   break;
   case "Like":
   action_holder.innerHTML="<input id='action_msg' list='reaction_group' placeholder='choose reaction' onclick='nuller(this)' onchange='action_in(this)' style='display:none' value='Like'></input>";
   break;
